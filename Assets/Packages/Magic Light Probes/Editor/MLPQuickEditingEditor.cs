...
namespace MagicLightProbes
{
    ...
    public class MLPQuickEditingEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EventType currentEvent = UnityEngine.Event.current.type;            
            ...
            if (quickEditing.parent.calculated)
            {
                ...
                switch (quickEditing.parent.fillingMode)
                {
                    case MagicLightProbes.FillingMode.SeparateFilling:
                        ...
                        quickEditing.drawDistance = EditorGUILayout.FloatField(quickEditing.drawDistance, GUILayout.MaxWidth(250));
                        ...
                        GUILayout.Label("Min/Max", GUILayout.MinWidth(200));
                        ...
                        if (quickEditing.parent.recombinationNeeded)
                        {
                            if(GUILayout.Button("Update Combined Volume"))
                            {
                                quickEditing.parent.CombineVolumes(quickEditing.parent.allVolumes.ToArray());
                            }
                        }

                        GUILayout.BeginHorizontal();

                        GUILayout.Label("Total Probes In Volume: ", GeneralMethods.managerWindowBoldLabelStyle, GUILayout.Width(250));
                        GUILayout.Label(quickEditing.parent.totalProbesInVolume.ToString(), GeneralMethods.managerWindowBoldLabelStyle);
